...
public class EasyPermissions {
    ...
    public static void showPermissonsDialog(Object object, int requestCode, String[] perms) {
        ...
        Dialog tipsDialog          = new Dialog(activity, R.style.noframe_dialog);
        tipsDialog.setContentView(permissionsTipsView);
        permissionsTipsView.findViewById(R.id.open_now_tv).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public static void showHelperDialog(Object object, int requestCode, String[] perms) {
        ...
        Dialog helpDialog = new Dialog(activity, R.style.noframe_dialog);
        helpDialog.setContentView(helpView);
        helpView.findViewById(R.id.set_tv).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                helpDialog.dismiss();
