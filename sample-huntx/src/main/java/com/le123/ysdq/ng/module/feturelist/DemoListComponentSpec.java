...
class DemoListComponentSpec {
    ...
    static Component onCreateLayout(
        ComponentContext c, @Prop List<FeturesListActivity.DemoListDataModel> dataModels) {
        return RecyclerCollectionComponent.create(c)
            .section(
                DataDiffSection.<FeturesListActivity.DemoListDataModel>create(new SectionContext(c))
                    .data(dataModels)
    ...
    static RenderInfo onRender(
        ...
        @FromEvent FeturesListActivity.DemoListDataModel model,
        @FromEvent int index) {
    ...
    static int[] getUpdatedIndices(@Nullable int[] parentIndices, int currentIndex) {
        ...
        int[] updatedIndices = Arrays.copyOf(parentIndices, parentIndices.length + 1);
    ...
    static boolean isSameItem(
        ComponentContext c,
        @FromEvent FeturesListActivity.DemoListDataModel previousItem,
        @FromEvent FeturesListActivity.DemoListDataModel nextItem) {
