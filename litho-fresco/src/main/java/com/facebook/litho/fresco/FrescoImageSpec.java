...
public class FrescoImageSpec {
    ...
    @PropDefault
    public static final float imageAspectRatio = FrescoImageDefaults.DEFAULT_IMAGE_ASPECT_RATION;

    @PropDefault
    public static final ScalingUtils.ScaleType actualImageScaleType =
    ...
    @PropDefault
    public static final ScalingUtils.ScaleType placeholderImageScaleType =
        FrescoImageDefaults.DEFAULT_SCALE_TYPE;

    @PropDefault
    public static final ScalingUtils.ScaleType progressBarImageScaleType =
        FrescoImageDefaults.DEFAULT_SCALE_TYPE;

    @PropDefault
    public static final ScalingUtils.ScaleType retryImageScaleType =
        FrescoImageDefaults.DEFAULT_SCALE_TYPE;
    ...
    public static DraweeDrawable<GenericDraweeHierarchy> onCreateMountContent(Context c) {
