...
public abstract class Transition {
     ...
     */
    public static final Transition.TransitionKeyType DEFAULT_TRANSITION_KEY_TYPE = TransitionKeyType.LOCAL;
    ...
    private static class RootItemResolver implements Resolver {
        ...
        public float getCurrentState(PropertyHandle propertyHandle) {
            LayoutOutput root = mLayoutState.getMountableOutputAt(0);
    ...
    public static float getRootAppearFromValue(
