...
import com.facebook.litho.component.ComponentHostUtils;
...
public class TouchExpansionDelegate extends TouchDelegate {
    ...
    public TouchExpansionDelegate(ComponentHost host) {
     ...
     */
    public void registerTouchExpansion(int index, View view, Rect touchExpansion) {
     ...
     * @param index The drawing order index of the given view.
     */
    public void unregisterTouchExpansion(int index) {
     ...
     */
    public void moveTouchExpansionIndexes(int oldIndex, int newIndex) {
