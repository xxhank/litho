...
public class WorkingRangeStatusHandler {
    ...
    public boolean isInRange(String name, Component component) {
    ...
    private int getStatus(String name, Component component) {
        String key = generateKey(name, component.getGlobalKey());
    ...
    public void setEnteredRangeStatus(String name, Component component) {
        setStatus(name, component, STATUS_IN_RANGE);
    }

    public void setExitedRangeStatus(String name, Component component) {
    ...
    @VisibleForTesting
    public void setStatus(String name, Component component, @WorkingRangeStatus int status) {
