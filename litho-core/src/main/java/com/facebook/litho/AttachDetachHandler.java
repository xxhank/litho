...
public class AttachDetachHandler {
     ...
     */
    public void onAttached(@Nullable Map<String, Component> attachable) {
        @Nullable Map<String, Component> toAttach;
        @Nullable Map<String, Component> toDetach;
        synchronized (this) {
    ...
    public void onDetached() {
        ...
        for (int i = 0, size = toDetach.size(); i < size; i++) {
            Component component = toDetach.get(i);
            component.onDetached(component.getScopedContext());
        }
    }
    ...
    @VisibleForTesting
    @Nullable
    public Map<String, Component> getAttached() {
        return mAttached;
    }
}
