...
import com.facebook.litho.mount.DefaultMountContentPool;
...
public abstract class ComponentLifecycle implements EventDispatcher, EventTriggerTarget {
    ...
    public static final YogaMeasureFunction sMeasureFunction =
        new YogaMeasureFunction() {
            ...
            public long measure(
                ...
                if (Component.isNestedTree(component) || node.hasNestedTree()) {
                    ...
                    Size size = acquireSize(Integer.MIN_VALUE /* initialValue */);
    ...
    public void mount(ComponentContext c, Object convertContent) {
    ...
    public void bind(ComponentContext c, Object mountedContent) {
    ...
    public void unbind(ComponentContext c, Object mountedContent) {
        onUnbind(c, mountedContent);
    }

    public void unmount(ComponentContext c, Object mountedContent) {
        onUnmount(c, mountedContent);
    }

    public final @Nullable Transition createTransition(ComponentContext c) {
        Transition transition = onCreateTransition(c);
        if (transition != null) {
    ...
    @ThreadSafe(enableChecks = false)
    public Component createComponentLayout(ComponentContext c) {
    ...
    public static void dispatchErrorEvent(ComponentContext c, ErrorEvent e) {
        ...
        EventHandler<ErrorEvent> errorHandler = scope.getErrorHandler();
    ...
    public void loadStyle(ComponentContext c, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        c.setDefStyle(defStyleAttr, defStyleRes);
        onLoadStyle(c);
        c.setDefStyle(0, 0);
    }

    public void loadStyle(ComponentContext c) {
        onLoadStyle(c);
    }
     ...
     */
    public TreeProps getTreePropsForChildren(ComponentContext c, TreeProps previousTreeProps) {
    ...
    public void onPrepare(ComponentContext c) {
        // do nothing, by default
    }

    public void onLoadStyle(ComponentContext c) {
    }
    ...
    public void onUnbind(ComponentContext c, Object mountedContent) {
        // Do nothing by default.
    }
    ...
    public void createInitialState(ComponentContext c) {
    }
    ...
    public void dispatchOnEnteredRange(String name) {
        // Do nothing by default
    }

    public void dispatchOnExitedRange(String name) {
        // Do nothing by default
    }
    ...
    public final boolean shouldComponentUpdate(Component previous, Component next) {
        if (isPureRender()) {
    ...
    public boolean canUsePreviousLayout(ComponentContext context) {
    ...
    protected static <E> EventHandler<E> newEventHandler(
        ...
        EventHandler<E> eventHandler = c.newEventHandler(id, params);
    ...
    protected static <E> EventHandler<E> newEventHandler(Component c, int id, Object[] params) {
        EventHandler<E> eventHandler = new EventHandler<>(c, id, params);
    ...
    public @Nullable RenderData recordRenderData(RenderData toRecycle) {
        return null;
    }

    public void applyPreviousRenderData(RenderData previousRenderData) {
    }
