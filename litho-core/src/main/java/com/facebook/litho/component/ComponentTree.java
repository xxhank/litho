...
import com.facebook.litho.mount.IncrementalMountHelper;
...
import static com.facebook.litho.thread.ThreadUtils.assertHoldsLock;
...
import static com.facebook.litho.layout.LayoutState.CalculateLayoutSource;
...
public class ComponentTree {
    ...
    @ThreadConfined(ThreadConfined.UI)
    @Nullable
    public Transition.RootBoundsTransition mRootWidthAnimation;
    ...
    @ThreadConfined(ThreadConfined.UI)
    @Nullable
    public Transition.RootBoundsTransition mRootHeightAnimation;
    ...
    protected ComponentTree(Builder builder) {
        ...
        StateHandler builderStateHandler = builder.stateHandler;
        mStateHandler =
    ...
    private LayoutState setBestMainThreadLayoutAndReturnOldLayout() {
        ...
        boolean isMainThreadLayoutBest = isBestMainThreadLayout();
    ...
    private void dispatchNewLayoutStateReady() {
        NewLayoutStateReadyListener listener = mNewLayoutStateReadyListener;
        if (listener != null) {
    ...
    public void maybeCollectTransitions() {
        ...
        MountState mountState = mLithoView.getMountState();
     ...
     */
    @ThreadConfined(ThreadConfined.UI)
    public int getInitialAnimatedLithoViewWidth(int currentAnimatedWidth, boolean hasNewComponentTree) {
     ...
     */
    @ThreadConfined(ThreadConfined.UI)
    public int getInitialAnimatedLithoViewHeight(int currentAnimatedHeight, boolean hasNewComponentTree) {
        return getInitialAnimatedLithoViewDimension(
    ...
    @ThreadConfined(ThreadConfined.UI) public void setRootWidthAnimation(@Nullable Transition.RootBoundsTransition rootWidthAnimation) {
        mRootWidthAnimation = rootWidthAnimation;
    }

    @ThreadConfined(ThreadConfined.UI)
    public void setRootHeightAnimation(@Nullable Transition.RootBoundsTransition rootHeightAnimation) {
    ...
    public void mountComponent(@Nullable Rect currentVisibleArea, boolean processVisibilityOutputs) {
        ...
        boolean isDirtyMount = mLithoView.isMountStateDirty();
    ...
    public void forceMainThreadLayout() {
        assertMainThread();
    ...
    public void measure(int widthSpec, int heightSpec, int[] measureOutput, boolean forceLayout) {
        ...
        if (component != null) {
            ...
            @Nullable Map<String, Component> attachables;
            synchronized (this) {
    ...
    public void updateStateLazy(String componentKey, StateUpdate stateUpdate) {
        synchronized (this) {
            if (mRoot == null) {
                return;
            }
    ...
    public void applyLazyStateUpdatesForContainer(String componentKey, StateContainer container) {
    ...
    public void updateStateSync(String componentKey, StateUpdate stateUpdate, String attribution) {
    ...
    public void updateStateInternal(boolean isAsync, String attribution) {

        Component           root;
        @Nullable TreeProps rootTreeProps;
    ...
    public boolean shouldCreateInitialStateOncePerThread() {
    ...
    public synchronized @Nullable void consumeStateUpdateTransitions(
    ...
    public RenderState consumePreviousRenderState() {
        RenderState previousRenderState = mPreviousRenderState;
    ...
    public void showTooltip(LithoTooltip lithoTooltip, String anchorGlobalKey, int xOffset, int yOffset) {
        assertMainThread();
    ...
    private Component wrapRootInErrorBoundary(Component originalRoot) {
        ...
        // component.
        RootWrapperComponentFactory rootWrapperComponentFactory =
    ...
    private void setRootAndSizeSpecInternal(
        ...
        synchronized (this) {
            ...
            boolean widthSpecInitialized  = widthSpec != SIZE_UNINITIALIZED;
            boolean heightSpecInitialized = heightSpec != SIZE_UNINITIALIZED;

            boolean widthSpecDidntChange  = !widthSpecInitialized || widthSpec == mWidthSpec;
            boolean heightSpecDidntChange = !heightSpecInitialized || heightSpec == mHeightSpec;
            boolean sizeSpecDidntChange   = widthSpecDidntChange && heightSpecDidntChange;
            LayoutState mostRecentLayoutState =
                mBackgroundLayoutState != null ? mBackgroundLayoutState : mMainThreadLayoutState;
            boolean allSpecsWereInitialized =
                widthSpecInitialized
                    && heightSpecInitialized
                    && mWidthSpec != SIZE_UNINITIALIZED
                    && mHeightSpec != SIZE_UNINITIALIZED;
            boolean sizeSpecsAreCompatible =
                sizeSpecDidntChange
            ...
            boolean rootDidntChange = !rootInitialized || root.getId() == mRoot.getId();
    ...
    @VisibleForTesting
    @Nullable
    public AttachDetachHandler getAttachDetachHandler() {
    ...
    private LayoutStateFuture createLayoutStateFutureAndCancelRunning(
        ...
        synchronized (mLayoutStateFutureLock) {
            ...
            for (int i = 0; i < mLayoutStateFutures.size(); i++) {
                LayoutStateFuture runningFuture = mLayoutStateFutures.get(i);
    ...
    protected @Nullable LayoutState calculateLayoutState(
        ...
        synchronized (mLayoutStateFutureLock) {
            boolean canReuse = false;
            for (int i = 0; i < mLayoutStateFutures.size(); i++) {
                LayoutStateFuture runningLsf = mLayoutStateFutures.get(i);
    ...
    @VisibleForTesting
    public List<LayoutStateFuture> getLayoutStateFutures() {
    ...
    public class LayoutStateFuture {
        ...
        private LayoutStateFuture(
            ...
            isFromSyncLayout = isFromSyncLayout(source);
            this.source = source;
        ...
        private LayoutState calculateLayoutStateInternal() {
            ...
            LayoutStateFuture layoutStateFuture =
                ...
                : null;
            ComponentContext contextWithStateHandler = getNewContextForLayout(layoutStateFuture);
        ...
        private ComponentContext getNewContextForLayout(@Nullable LayoutStateFuture layoutStateFuture) {
            ...
            synchronized (ComponentTree.this) {
                KeyHandler keyHandler =
                    ...
                    ? new KeyHandler(getContextLogger())
                    : null;
        ...
        private LayoutState resolvePartialInternalNodeAndCalculateLayout(
            LayoutState partialLayoutState) {
            if (released) {
                return null;
            }
            LayoutState result =
    ...
    public static class Builder {
        ...
        public Builder useCancelableLayoutFutures(boolean isEnabled) {
            useCancelableLayoutFutures = isEnabled;
            return this;
        }
        ...
        public Builder canInterruptAndMoveLayoutsBetweenThreads(boolean isEnabled) {
            canInterruptAndMoveLayoutsBetweenThreads = isEnabled;
            return this;
        }
