...
public class ComponentHostUtils {
     ...
     */
    public static <T> void scrapItemAt(
     ...
     */
    public static <T> boolean existsScrapItemAt(int index, SparseArrayCompat<T> scrapItems) {
     ...
     */
    public static void maybeSetDrawableState(View view, Drawable drawable, int flags, NodeInfo nodeInfo) {
     ...
     */
    public static <T> void removeItem(
        int index, SparseArrayCompat<T> items, SparseArrayCompat<T> scrapItems) {
     ...
     */
    public static void mountDrawable(
    ...
    public static List<?> extractContent(SparseArrayCompat<MountItem> items) {
        int size = items.size();
        if (size == 1) {
    ...
    public static TextContent extractTextContent(List<?> items) {
        int size = items.size();
        if (size == 1) {
    ...
    public static ImageContent extractImageContent(List<?> items) {
        int size = items.size();
        if (size == 1) {
            Object item = items.get(0);
