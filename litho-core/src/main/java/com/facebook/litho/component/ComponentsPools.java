...
public class ComponentsPools {
    ...
    public static Object acquireMountContent(Context context, ComponentLifecycle lifecycle) {
        MountContentPool pool = getMountContentPool(context, lifecycle);
        if (pool == null) {
    ...
    public static void release(Context context, ComponentLifecycle lifecycle, Object mountContent) {
        MountContentPool pool = getMountContentPool(context, lifecycle);
        if (pool != null) {
    ...
    public static void onContextDestroyed(Context context) {
        synchronized (sMountContentLock) {
            ...
            Iterator<Map.Entry<Context, SparseArray<MountContentPool>>> it =
    ...
    public static List<MountContentPool> getMountContentPools() {
        ArrayList<MountContentPool> pools = new ArrayList<>();
        synchronized (sMountContentLock) {
