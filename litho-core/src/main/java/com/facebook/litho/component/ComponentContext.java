...
public class ComponentContext {
    ...
    public void setDefStyle(@AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
    ...
    public EventHandler newEventHandler(int id) {
     ...
     */
    public <E> EventTrigger<E> newEventTrigger(String childKey, int id) {
        String parentKey = mComponentScope == null ? "" : mComponentScope.getGlobalKey();
        return new EventTrigger<>(parentKey, id, childKey);
    }

    public InternalNode newLayoutBuilder(@AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
    ...
    public void applyStyle(InternalNode node, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
