...
public class LithoView extends ComponentHost {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        boolean animating = mAnimatedWidth != -1 || mAnimatedHeight != -1;
        // up to date view sizes, taking into account running animations
        int upToDateWidth  = (mAnimatedWidth != -1) ? mAnimatedWidth : getWidth();
        int upToDateHeight = (mAnimatedHeight != -1) ? mAnimatedHeight : getHeight();
        mAnimatedWidth = -1;
        mAnimatedHeight = -1;
        ...
        if (layoutParams instanceof LayoutManagerOverrideParams) {
            ...
            int overrideHeightSpec = layoutManagerOverrideParams.getHeightMeasureSpec();
    ...
    @Override
    public void performLayout(boolean changed, int left, int top, int right, int bottom) {
        if (mComponentTree != null) {
    ...
    private void recursivelySetVisibleHint(boolean isVisible) {
        List<LithoView> childLithoViews =
    ...
    public void processVisibilityOutputs(LayoutState layoutState, Rect currentVisibleArea) {
    ...
    private static void logError(
        ...
        ComponentsLogger.LogLevel logLevel =
    ...
    private static class AccessibilityStateChangeListener
        ...
        public void onAccessibilityStateChanged(boolean enabled) {
            ...
            LithoView lithoView = mLithoView.get();
            if (lithoView == null) {
                return;
            }
