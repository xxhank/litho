...
package com.facebook.litho.geometry;
...
public class Border {
    ...
    public static final int RADIUS_COUNT = 4;

    public final float[] mRadius     = new float[RADIUS_COUNT];
    public final int[]   mEdgeWidths = new int[EDGE_COUNT];
    public final int[]   mEdgeColors = new int[EDGE_COUNT];
    ...
    public void setEdgeWidth(YogaEdge edge, int width) {
        if (width < 0) {
    ...
    public void setEdgeColor(YogaEdge edge, @ColorInt int color) {
        setEdgeValue(mEdgeColors, edge, color);
    }

    public static int getEdgeColor(int[] colorArray, YogaEdge edge) {
