...
public class ViewCompatComponent<V extends View> extends Component {
    ...
    protected void onMeasure(
        ...
        V                      toMeasure    = (V) ComponentsPools.acquireMountContent(c.getAndroidContext(), this);
    ...
    @Override public void onPrepare(ComponentContext c) {
        mViewBinder.prepare();
    }

    @Override public void bind(ComponentContext c, Object mountedContent) {
        mViewBinder.bind((V) mountedContent);
    }

    @Override public void unbind(ComponentContext c, Object mountedContent) {
