...
public class MountItem {
    ...
    public   static final int LAYOUT_FLAG_DUPLICATE_PARENT_STATE = 1 << 0;
    public   static final int LAYOUT_FLAG_DISABLE_TOUCHABLE = 1 << 1;
    public  static final int LAYOUT_FLAG_MATCH_HOST_BOUNDS = 1 << 2;
    ...
    public  MountItem(Component component, ComponentHost host, Object content, LayoutOutput layoutOutput) {
        this(
            component,
            host,
            content,
    ...
    public  void setHost(ComponentHost host) {
        mHost = host;
    }
    ...
    @Nullable public TransitionId getTransitionId() {
    ...
    public void releaseMountContent(Context context, String releaseCause) {
        if (mIsReleased) {
    ...
    public static boolean isDuplicateParentState(int flags) {
        return (flags & LAYOUT_FLAG_DUPLICATE_PARENT_STATE) == LAYOUT_FLAG_DUPLICATE_PARENT_STATE;
    }

    public static boolean isTouchableDisabled(int flags) {
