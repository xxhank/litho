...
import com.facebook.litho.test.TestComponentTree;
...
public final class ComponentTestHelper {
    ...
    private static List<SubComponent> getImmediateSubComponents(
        ...
        List<SubComponent> subComponents = new ArrayList<>(components.size());
