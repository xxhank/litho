...
public interface ClassNames {
    ...
    ClassName COMPONENT_CONTEXT = ClassName.bestGuess("com.facebook.litho.component.ComponentContext");
    ClassName COMPONENT_LAYOUT  = ClassName.bestGuess("com.facebook.litho.component.ComponentLayout");

    ClassName COMPONENT                               = ClassName.bestGuess("com.facebook.litho.component.Component");
    ClassName COMPONENT_BUILDER                       = ClassName.bestGuess("com.facebook.litho.component.Component.Builder");
    ClassName COMPONENT_LIFECYCLE                     = ClassName.bestGuess("com.facebook.litho.component.ComponentLifecycle");
    ClassName COMPONENT_LIFECYCLE_MOUNT_TYPE          =
        ClassName.bestGuess("com.facebook.litho.component.ComponentLifecycle.MountType");
    ClassName COMPONENT_LIFECYCLE_MOUNT_TYPE_DRAWABLE =
        ClassName.bestGuess("com.facebook.litho.component.ComponentLifecycle.MountType.DRAWABLE");
    ClassName COMPONENT_LIFECYCLE_MOUNT_TYPE_VIEW     =
        ClassName.bestGuess("com.facebook.litho.component.ComponentLifecycle.MountType.VIEW");
    ClassName COMPONENT_LIFECYCLE_MOUNT_TYPE_NONE     =
        ClassName.bestGuess("com.facebook.litho.component.ComponentLifecycle.MountType.NONE");

    ClassName TRANSITON            = ClassName.bestGuess("com.facebook.litho.Transition");
    ClassName TRANSITION_CONTAINER =
        ClassName.bestGuess("com.facebook.litho.component.ComponentLifecycle.TransitionContainer");
