...
import static com.facebook.litho.layout.LayoutOutput.STATE_DIRTY;
import static com.facebook.litho.layout.LayoutOutput.STATE_UNKNOWN;
import static com.facebook.litho.layout.LayoutOutput.STATE_UPDATED;
import static com.facebook.litho.layout.LayoutState.calculate;
import static com.facebook.litho.layout.LayoutState.createDiffNode;
...
public class TreeDiffingTest {
  ...
  public void testLayoutOutputReuse() {
    ...
    for (int i = 0, count = prevLayoutState.getMountableOutputCount(); i < count; i++) {
      assertThat(layoutState.getMountableOutputAt(i).getId())
          .isEqualTo(prevLayoutState.getMountableOutputAt(i).getId());
    }
  }
