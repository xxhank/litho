...
public class LayoutStateCreateTreeTest {
    ...
    public void testHandlersAreAppliedToCorrectInternalNodes() {
        EventHandler<ClickEvent>          clickHandler1          = mock(EventHandler.class);
        EventHandler<ClickEvent>          clickHandler2          = mock(EventHandler.class);
        EventHandler<ClickEvent>          clickHandler3          = mock(EventHandler.class);
        EventHandler<LongClickEvent>      longClickHandler1      = mock(EventHandler.class);
        EventHandler<LongClickEvent>      longClickHandler2      = mock(EventHandler.class);
        EventHandler<LongClickEvent>      longClickHandler3      = mock(EventHandler.class);
        EventHandler<TouchEvent>          touchHandler1          = mock(EventHandler.class);
        EventHandler<TouchEvent>          touchHandler2          = mock(EventHandler.class);
        EventHandler<TouchEvent>          touchHandler3          = mock(EventHandler.class);
        EventHandler<InterceptTouchEvent> interceptTouchHandler1 = mock(EventHandler.class);
        EventHandler<InterceptTouchEvent> interceptTouchHandler2 = mock(EventHandler.class);
        EventHandler<InterceptTouchEvent> interceptTouchHandler3 = mock(EventHandler.class);
        EventHandler<FocusChangedEvent>   focusChangedHandler1   = mock(EventHandler.class);
        EventHandler<FocusChangedEvent>   focusChangedHandler2   = mock(EventHandler.class);
        EventHandler<FocusChangedEvent>   focusChangedHandler3   = mock(EventHandler.class);
    ...
    public void testAddingAllAttributes() {
        ...
        EventHandler<LongClickEvent>             longClickHandler          = mock(EventHandler.class);
        EventHandler<TouchEvent>                 touchHandler              = mock(EventHandler.class);
        EventHandler<InterceptTouchEvent>        interceptTouchHandler     = mock(EventHandler.class);
        EventHandler<FocusChangedEvent>          focusChangedHandler       = mock(EventHandler.class);
        EventHandler<VisibleEvent>               visibleHandler            = mock(EventHandler.class);
        EventHandler<FocusedVisibleEvent>        focusedHandler            = mock(EventHandler.class);
        EventHandler<UnfocusedVisibleEvent>      unfocusedHandler          = mock(EventHandler.class);
        EventHandler<FullImpressionVisibleEvent> fullImpressionHandler     = mock(EventHandler.class);
        EventHandler<InvisibleEvent>             invisibleHandler          = mock(EventHandler.class);
        EventHandler<VisibilityChangedEvent>     visibleRectChangedHandler = mock(EventHandler.class);
        ...
        StateListAnimator stateListAnimator = mock(StateListAnimator.class);
    ...
    private class MockInternalNodeComponentContext extends ComponentContext {
        ...
        @Override InternalNode newLayoutBuilder(@AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
            return new TestInternalNode(this);
        }

        @Override
        ComponentContext makeNewCopy() {
            return new MockInternalNodeComponentContext(getAndroidContext());
        }
    }
