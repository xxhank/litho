...
public class DelegateMethodValidationTest {
        ...
        assertThat(validationErrors.get(0).message)
            .isEqualTo(
                "Methods annotated with interface "
                    ...
                    + "com.facebook.litho.component.ComponentContext, int, int.");
    }
        ...
        assertThat(validationErrors.get(0).message)
            .isEqualTo(
                "A method annotated with @OnCreateLayout needs to return "
                    + "com.facebook.litho.component.Component. Note that even if your return value is a "
                    + "subclass of com.facebook.litho.component.Component, you should still use "
                    + "com.facebook.litho.component.Component as the return type.");
    }
    ...
    public void testInterStageInputParamAnnotationNotValid() {
        InterStageInputParamModel interStageInputParamModel =
