...
public class TriggerGeneratorTest {
  ...
  public void testGenerateAcceptTriggerEvent() {
    assertThat(TriggerGenerator.generateAcceptTriggerEvent(mSpecModel).toString())
        .isEqualTo(
            "@java.lang.Override\n"
                + "public java.lang.Object acceptTriggerEvent(final com.facebook.litho.event.EventTrigger eventTrigger,\n"
  ...
  public void testGenerateOnTriggerMethods() {
    ...
    assertThat(dataHolder.getMethodSpecs().get(0).toString())
        .isEqualTo(
            "private java.lang.Object testTriggerMethod1(com.facebook.litho.event.EventTriggerTarget _abstract,\n"
    ...
    assertThat(dataHolder.getMethodSpecs().get(1).toString())
        .isEqualTo(
            "private void testTriggerMethod2(com.facebook.litho.event.EventTriggerTarget _abstract) {\n"
                + "  Test _ref = (Test) _abstract;\n"
  ...
  public void testGenerateStaticTriggerMethod() {
    ...
    assertThat(dataHolder.getMethodSpecs().get(0).toString())
        .isEqualTo(
            "public static <T extends java.lang.CharSequence> java.lang.Object testTriggerMethod1(com.facebook.litho.component.ComponentContext c,\n"
                + "    java.lang.String key, java.lang.Object arg2, T arg3, long arg4) {\n"
                + "  int methodId = -773082596;\n"
                + "  com.facebook.litho.event.EventTrigger trigger = getEventTrigger(c, methodId, key);\n"
                + "  if (trigger == null) {\n"
                + "    return null;\n"
                + "  }\n"
    ...
    assertThat(dataHolder.getMethodSpecs().get(1).toString())
        .isEqualTo(
            "public static <T extends java.lang.CharSequence> java.lang.Object testTriggerMethod1(com.facebook.litho.event.EventTrigger trigger,\n"
                + "    java.lang.Object arg2, T arg3, long arg4) {\n"
                + "  com.facebook.litho.specmodels.generator.TriggerGeneratorTest.TestEvent _eventState = new com.facebook.litho.specmodels.generator.TriggerGeneratorTest.TestEvent();\n"
                + "  _eventState.arg4 = arg4;\n"
                + "  return (java.lang.Object) trigger.dispatchOnTrigger(_eventState, new Object[] {\n"
    ...
    assertThat(dataHolder.getMethodSpecs().get(2).toString())
        .isEqualTo(
            "static <T extends java.lang.CharSequence> java.lang.Object testTriggerMethod1(com.facebook.litho.component.ComponentContext c,\n"
                + "    java.lang.Object arg2, T arg3, long arg4) {\n"
                + "  Test component = (Test) c.getComponentScope();\n"
                + "  return component.testTriggerMethod1(\n"
                + "      (com.facebook.litho.event.EventTriggerTarget) component,\n"
                + "      arg2,\n"
                + "      arg3,\n"
                + "      arg4);\n"
                + "}\n");
    ...
    assertThat(dataHolder.getMethodSpecs().get(3).toString())
        .isEqualTo(
            "public static void testTriggerMethod2(com.facebook.litho.component.ComponentContext c, java.lang.String key) {\n"
    ...
    assertThat(dataHolder.getMethodSpecs().get(4).toString())
        .isEqualTo(
            "public static void testTriggerMethod2(com.facebook.litho.event.EventTrigger trigger) {\n"
                + "  java.lang.Object _eventState = new java.lang.Object();\n"
                + "  trigger.dispatchOnTrigger(_eventState, new Object[] {\n"
                + "      });\n"
                + "}\n");
    ...
    assertThat(dataHolder.getMethodSpecs().get(5).toString())
        .isEqualTo(
            "static void testTriggerMethod2(com.facebook.litho.component.ComponentContext c) {\n"
                + "  Test component = (Test) c.getComponentScope();\n"
  ...
  public void testGenerateStaticGetTriggerMethods() {
    ...
    assertThat(dataHolder.getMethodSpecs().get(0).toString())
        .isEqualTo(
            "public static com.facebook.litho.event.EventTrigger testTriggerMethod1Trigger(com.facebook.litho.component.ComponentContext c,\n"
    ...
    assertThat(dataHolder.getMethodSpecs().get(1).toString())
        .isEqualTo(
            "public static com.facebook.litho.event.EventTrigger testTriggerMethod2Trigger(com.facebook.litho.component.ComponentContext c,\n"
                + "    java.lang.String key) {\n"
                + "  int methodId = 969727739;\n"
                + "  return newEventTrigger(c, key, methodId);\n"
                + "}\n");
