...
public class AppBlockCanaryContext extends BlockCanaryContext {
     ...
     */
    @Override public int provideDumpInterval() {
     ...
     */
    @Override public boolean zip(File[] src, File dest) {
        return false;
    }
     ...
     */
    @Override public void upload(File zippedFile) {
     ...
     */
    @Override public boolean filterNonConcernStack() {
        return false;
    }
     ...
     */
    @Override public boolean deleteFilesInWhiteList() {
        return true;
    }
     ...
     */
    @Override public void onBlock(Context context, BlockInfo blockInfo) {
