...
// JMethod /////////////////////////////////////////////////////////////////////////////////////////
        ...
        namespace {
            ...
            struct ArgsArraySetter<idx, Arg, Args...> {
                static void
                set(alias_ref<JArrayClass<jobject>::javaobject> array, Arg arg0, Args... args) {
        ...
        template<typename... Args>
        inline void
        JMethod<void(Args...)>::operator()(alias_ref<jobject> self, Args... args) const {
...
/// JMethod specialization for references that wraps the return value in a @ref local_ref
        ...
        template<typename R, typename... Args>
        inline auto
        JMethod<R(Args...)>::operator()(alias_ref<jobject> self, Args... args) const -> local_ref<JniRet> {
            const auto env = Environment::current();
        ...
        template<typename... Args>
        inline void
        JStaticMethod<void(Args...)>::operator()(alias_ref<jclass> cls, Args... args) const {
            const auto env = Environment::current();
...
/// JNonvirtualMethod specialization for references that wraps the return value in a @ref local_ref
        ...
        class JNonvirtualMethod<R(Args...)> : public JMethodBase {
            ...
            /// Invoke a method and return a local reference wrapping the result
            local_ref<JniRet>
            operator()(alias_ref<jobject> self, alias_ref<jclass> cls, Args... args) const {
                const auto env = Environment::current();
